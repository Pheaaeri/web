	...
	Datepicker.prototype = {
		...
		fillDow: function(){
			...
			while (dowCnt < this.weekStart + 7) {
				html += '<th class="dow" style="text-align: center">'+dates[this.language].daysMin[(dowCnt++)%7]+'</th>';
			}
			html += '</tr>';
		...
		fill: function() {
			...
			while(prevMonth.valueOf() < nextMonth) {
				...
				html.push('<td class="'+clsName.join(' ')+'"' + (tooltip ? ' title="'+tooltip+'"' : '') + ' width="30" style="text-align: center">'+prevMonth.getUTCDate() + '</td>');
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								...
								'<th colspan="5" class="datepicker-switch" style="text-align: center"></th>'+
